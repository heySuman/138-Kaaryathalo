...
export default function Edit({ categories, jobPosting }: JobPostingFormProps) {
    const { data, setData, patch, processing, errors, reset } = useForm<Partial<JobPosting>>(jobPosting);

    const [skillInput, setSkillInput] = useState('');

    const handleSubmit = (e: FormEvent) => {
        e.preventDefault();
        patch(route('client.job-posting.update', jobPosting.id), {
            onSuccess: () => reset(),
            onError: () => {
                console.log(errors);
            },
        ...
        <AppLayout>
            ...
            <div className="pt-6">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="mb-2 flex items-center justify-between">
                        <div>
                            <h2 className="text-2xl font-black">Update Job Posting</h2>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="mt-5 space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <Select
                                onValueChange={(value) =>
                                    setData('timeline', value as 'less than a month' | 'less than three months' | 'more than three months')
                                }
                        ...
                        <div className="space-y-2">
                            ...
                            <Select
                                onValueChange={(value) => setData('payment_type', value as 'fixed' | 'hourly')}
                                defaultValue={data.payment_type || 'fixed'}
                            >
                                <SelectTrigger>
                        ...
                        <div className="space-y-2">
                            ...
                            <Select
                                onValueChange={(value) => setData('visibility', value as 'public' | 'private')}
