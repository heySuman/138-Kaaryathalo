...
const featuresData: Feature[] = [
    {
        ...
        paragraph:
            'Kaaryathalo provides the local startup an opportunities to interact with the talents of different fields.',
    },
    {
        id: 2,
        icon: (
        ...
        paragraph:
            'Kaaryathalo is simple and user intuitive, can navigate through the system easily.',
    },
    {
        id: 3,
        icon: (
        ...
        title: 'Secure System',
        paragraph:
            'Security is our top priority, at Kaaryathalo you need not to worry about security.',
    },
    {
        id: 4,
        icon: (
        ...
        title: 'Payments',
        paragraph:
            'At Kaaryathalo, you have the provided payment gateway for the clients.',
    },
    {
        id: 5,
        icon: (
        ...
        title: 'Community',
        paragraph:
            'Kaaryathalo is built for the community, by the community',
    },
];
